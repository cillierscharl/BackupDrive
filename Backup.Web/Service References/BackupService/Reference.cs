...
namespace Backup.Web.BackupService {
    ...
    public interface IBackupService {
        ...
        Backup.Web.BackupService.UploadFileResponse UploadFile(Backup.Web.BackupService.BackupStream request);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IBackupServiceChannel : Backup.Web.BackupService.IBackupService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class BackupServiceClient : System.ServiceModel.ClientBase<Backup.Web.BackupService.IBackupService>, Backup.Web.BackupService.IBackupService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Backup.Web.BackupService.UploadFileResponse Backup.Web.BackupService.IBackupService.UploadFile(Backup.Web.BackupService.BackupStream request) {
            return base.Channel.UploadFile(request);
        }
        
        public void UploadFile(string Directory, string Name, string User, System.IO.Stream DataStream) {
            Backup.Web.BackupService.BackupStream inValue = new Backup.Web.BackupService.BackupStream();
            inValue.Directory = Directory;
            inValue.Name = Name;
            inValue.User = User;
            inValue.DataStream = DataStream;
            Backup.Web.BackupService.UploadFileResponse retVal = ((Backup.Web.BackupService.IBackupService)(this)).UploadFile(inValue);
        }
